...
namespace ToDoList.Controllers
{
    ...
    public class ToDoItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,Name,Date,StartDate,EndDate,Description")] ToDoItemModel toDoItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,Name,Date,StartDate,EndDate,Description")] ToDoItemModel toDoItem)
        {
            if (id != toDoItem.Id)
            {
                return NotFound();
